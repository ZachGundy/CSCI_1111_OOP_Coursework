...
public class Exercise23_3QuickSort {

    public static void main(String[] args) {
        Integer[] array1 = new Integer[]{23, 25, 7, 14, 85, 65};
        quickSort(array1);
        System.out.println(Arrays.toString(array1));

        Integer[] array2 = new Integer[]{3, 2, 7, 4, 8, 6, 1, 7};
        quickSort(array2, Integer::compareTo);
