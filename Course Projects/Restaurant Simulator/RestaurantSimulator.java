...
public class RestaurantSimulator extends Restaurant {
    ...
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            Restaurant restaurant = new Restaurant(25.14, 5, "Dumplings and Ham fried rice", 3);
            System.out.println("********");
            System.out.println(" Awesome you guys are going to a Chinese Restaurant!!! Enjoy :)");
