...
public class Exercise20_9RemoveBall extends Application {

    @Override // Override the start method in the Application class

    public void start(Stage primaryStage) {

        // Create a multiple ball Pain and a red border
        MultipleBallPane ballPane = new MultipleBallPane();
        ballPane.setStyle("-fx-border-color: red");

        // Make add and subtract buttons in hbox format
        ...
        // Create BorderPane and Place other GUI appropriately
    ...
    private class MultipleBallPane extends Pane {
        ...
        public void add() {
            ...
            double radius = 2 + Math.random() * 20;
            getChildren().add(new Ball(30, 30, radius, color));
        }

       // Remove Largest Ball First
